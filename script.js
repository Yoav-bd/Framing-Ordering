...
const addonPriceTable = {
    'Anti-Reflective Glass': { '30x20': 35, '40x30': 105, '60x40': 220, '70x50': 330, '90x60': 500, '100x70': 650, '120x80': 900, '130x90': 1100, '120x100': 1100, '150x100': 1400 },
...
const translations = {
    ...
    'KAPA White (Line)': 'קאפה לבנה (Line)',
    'KAPA Grey (Fix)': 'קאפה אפורה (Fix)',
    'Dibond': 'דיבונד',
    'Diasec': 'דיאסק',
    'Glossy': 'מבריק',
    'Matt': 'מט',
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (lang === 'he') {
        ...
        document.querySelector('.footnote p').innerHTML = 'המחירים המפורטים הם עבור גדלים סטנדרטיים. לקבלת הצעת מחיר עבור גדלים גדולים ומיוחדים, אנא צרו איתנו קשר. <span style="color:black; font-weight:bold;">מינימום הזמנה של 750 ש"ח.</span>';
        ...
        document.querySelector('.footnote p').innerHTML = 'Prices listed are for standard sizes. For large and special sizes, please contact us for a quote. <span style="color:black;">Minimum order of 750 NIS.</span>';
